...
3. **request**
  ...
  else if (lowerQuery.includes('blocked') || lowerQuery.includes('which packages were blocked') || lowerQuery.includes('blocked packages') || lowerQuery === "which packages were blocked in the last two weeks?") {
